...
\begin{frame}[fragile]{Teorioppgave 9}
    \includegraphics[width=\textwidth]{06t_q9.png}
\end{frame}
\begin{frame}[fragile]{Teorioppgave 9}
    Brute-force:
...
\begin{frame}[fragile]{Bonus}
    \centering
    \begin{figure}
        \includegraphics[height=0.75\textheight]{slimsopp_nrk.png}
...
\begin{frame}[fragile]{Bonus}
    \centering
    \begin{figure}
        \includegraphics[height=0.75\textheight]{slimsopp_labyrint.png}
